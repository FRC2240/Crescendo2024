...
private:
    ...
    //                                               r    g  b    w  spd num
    ctre::phoenix::led::LarsonAnimation red_larson  {255, 0, 0,   0, 0.5, CONSTANTS::CANDLE::NUM_LEDS};
    ctre::phoenix::led::LarsonAnimation blue_larson {0,   0, 255, 0, 0.5, CONSTANTS::CANDLE::NUM_LEDS};
