...
#pragma warning("Values extraordinary wrong")
      constexpr ModuleConfig FL{60, 61, 14, -0.091_tr};
      constexpr ModuleConfig FR{50, 51, 13, -0.175_tr};
      constexpr ModuleConfig BL{30, 31, 11, 0.176_tr};
      constexpr ModuleConfig BR{40, 41, 12, 0.247_tr};
